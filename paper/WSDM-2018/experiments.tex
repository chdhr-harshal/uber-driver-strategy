...
on any Wednesday in the dataset. Our model does not allow rides within the same zone. Hence, we ignore such rides while populating the entries of the matrix $\countmatrix^t$, resulting into diagonal entries being zeros.
