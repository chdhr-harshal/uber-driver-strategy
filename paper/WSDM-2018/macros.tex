...
\newcommand\fnote[1]{\captionsetup{font=small}\caption*{\textmd{#1}}}
...
% strategies
\newcommand{\naive}{{\textit{naive}}}
\newcommand{\relocation}{{\textit{relocation}}}
\newcommand{\flexible}{{\textit{flexible}}}
\newcommand{\relocationflexible}{{\textit{flexible-relocation}}}
\newcommand{\earningsgoal}{{\textit{fixed earnings goal}}}
...
\newcommand{\cumulativeearning}[3]{\ensuremath{\Phi^{#3}({#1,#2})}}
\newcommand{\inducedearningvector}[3]{\ensuremath{\mathbf{v}^{#1}({#2},{#3})}}
