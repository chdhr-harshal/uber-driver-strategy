...
the net reward for a driver transiting from zone $i$ to zone $j$. The net rewards include the driver's
share of earnings from a passenger minus the sundry expenses like gas, vehicle value depreciations, etc. These 
rewards are stored in the rewards matrix $\rewardsmatrix$ with entries $r(i,j)$.
